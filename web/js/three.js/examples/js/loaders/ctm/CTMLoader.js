				...
				if ( parameters.useWorker ) {
					...
					worker.onmessage = function( event ) {
						...
						for ( var i = 0; i < files.length; i ++ ) {
							...
							var e1 = Date.now();
							// if (LOG) console.log( "CTM data parse time [worker]: " + (e1-s) + " ms" );

							scope.createModel( ctmFile, callback );

							var e = Date.now();
							if (LOG) console.log( "model load time [worker]: " + (e-e1) + " ms, total: " + (e-s));
					...
					//var e = Date.now();
					//if (LOG) console.log( "CTM data parse time [inline]: " + (e-s) + " ms" );
