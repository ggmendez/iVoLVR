...
SPARKS.Emitter.prototype = {
	...
	step: function(emitter) {
		...
		if (!this._velocityVerlet) {
			...
			if (elapsed >= maxBlock) {
				//if (LOG) console.log('warning: sparks.js is fast fowarding engine, skipping steps', elapsed / emitter._TIMESTEP);
    ...
    removeAction: function (action) {
		...
		//if (LOG) console.log('removeAction', index, this._actions);
    },
...
SPARKS.VectorPool = {
	...
	_addToPool: function() {
		//if (LOG) console.log("creating some pools");
