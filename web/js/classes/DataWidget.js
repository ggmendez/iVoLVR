...
//            if (LOG) console.log("%cMouse UP over an DATAWIDGET", "background: lightgray; color: blue;");
//        });
...
//        canvas.add(visualVariable);        
        ...
        visualVariable.on('doubleTap', function (option) {
            theDataWidget.trigger('doubleTap');
        });
//        visualVariable.on('pressed', function (option) {
//            visualVariable.fill = 'red';
//            canvas.renderAll();
//        });

        visualVariable.outConnectors = new Array();
...
//                var targetObject = findVisualVariablePotentialDestination(canvasCoords);
