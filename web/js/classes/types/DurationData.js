...
//        this.set('colorForStroke', options.stroke || darkenrgb(66, 183, 91));
    ...
    setValue: function (durationValue, refreshCanvas) {
        ...
        if (durationValue.isDurationData) {
            ...
            if (theDataType.value) {
                previousOutputUnits = theDataType.value.outputUnits;
            }
            ...
            theDataType.value = durationValue.clone();

            if (previousOutputUnits) {
                theDataType.value.outputUnits = previousOutputUnits;
            }
            ...
            /*// Every time a value is set here, we also have to update the values of the outgoing connections
             ...
             outConnector.setValue(theDataType.value, false, true);
             });
    ...
    expand: function () {
        ...
        showDurationValue(theDataType, true);

    }


});
DataType.call(DurationData.prototype);
