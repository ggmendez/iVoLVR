...
//                                        connector.destination.bringToFront();
            ...
            'moving': function (options) {
                ...
                if (theVisualValue.connecting) {
                    ...
                    var topDataType = canvasCoords.y - ((theVisualValue.height * theVisualValue.scaleY / 2) + pointerRelativeToCenter.y);
                    var bottomDataType = canvasCoords.y + ((theVisualValue.height * theVisualValue.scaleY / 2) - pointerRelativeToCenter.y);
...
//                                            connector.destination.bringToFront();
                        ...
                        if (theCollection.collection && theCollection.collection.mapper) {
            ...
            'newInConnection': function (options) {
                ...
                } else if (incommingValue.isDataType) {
