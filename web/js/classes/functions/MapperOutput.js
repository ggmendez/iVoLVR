            ...
            'mouseup': function (options) {
                ...
                if (targetObject) {
                    ...
                    if (targetObject !== theMapperOutput) {
                        ...
                        } else if (targetObject.isOperator || targetObject.isVisualProperty || targetObject.isFunctionInput || targetObject.isDataType || targetObject.isVerticalCollection || targetObject.isMapperInput || targetObject.isMapperOutput || targetObject.isFunctionValuesCollection) {
