...
//                            var coordX = pageX - $('#theCanvas').offset().left;
//                            var coordY = pageY - $('#theCanvas').offset().top;
...
//                            widget.trueColor = 'rgb(' + r + ',  ' + g + ', ' + b + ')';
//                            widget.trueColorDarker = 'rgb(' + (r * 0.75).toFixed(0) + ', ' + (g * 0.75).toFixed(0) + ', ' + (b * 0.75).toFixed(0) + ')';

                            widget.trueColor = rgb(r, g, b);
                            widget.trueColorDarker = darkenrgb(r, g, b);

//                            if (LOG) console.log("widget.trueColorDarker: " + widget.trueColorDarker);
